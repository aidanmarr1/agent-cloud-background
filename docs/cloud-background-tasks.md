...
- OpenRouter/Gemini 3.5 Flash Lite: depends on model usage. The pinned Nitro route, `google/gemini-3.5-flash-lite:nitro`, is priced at $0.30 per 1M input tokens, $0.03 per 1M cached input tokens, and $2.50 per 1M output tokens at the time of this update. Check OpenRouter before changing customer pricing.
