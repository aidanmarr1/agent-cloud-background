...
- OpenRouter/Gemini 3.5 Flash Lite: depends on model usage. The pinned Exacto route, `google/gemini-3.5-flash-lite:exacto`, prioritizes providers with stronger tool-calling reliability; actual provider cost is recorded from OpenRouter usage. Check OpenRouter before changing customer pricing.
