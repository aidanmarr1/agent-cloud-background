...
- OpenRouter/Gemini 3.6 Flash: depends on model usage. The pinned Nitro route, `google/gemini-3.6-flash:nitro`, is priced at $1.50 per 1M input tokens, $0.15 per 1M cached-input tokens, and $7.50 per 1M output tokens at the time of this update. Check OpenRouter before changing customer pricing.
