...
assert.match(config, /export const STREAM_REQUEST_TIMEOUT_MS = 5_000/, 'streaming model requests must stay bounded while allowing the configured provider to start reliably')
