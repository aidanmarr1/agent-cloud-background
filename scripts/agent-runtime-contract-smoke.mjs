...
async function assertSourceContracts() {
  ...
  assert.match(agentLoop, /if \(requestLooksBrief\) \{[\s\S]*return 160/, 'explicitly concise saved artifacts must not trigger an unnecessary append solely to hit a generic report-length floor')
