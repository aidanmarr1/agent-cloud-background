...
async function assertSourceContracts() {
  ...
  assert.match(taskText, /Researching \$\{subject\} with current sources, then comparing the evidence and summarizing the findings\./, 'sandbox-ready acknowledgement must be natural and task-specific for research')
