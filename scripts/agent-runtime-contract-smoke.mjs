...
async function assertSourceContracts() {
  ...
  assert.doesNotMatch(llm, /forcedToolChoice/, 'Muse must retain reasoning for provider-compatible required and named tool choices')
  assert.doesNotMatch(llm, /providerCompatibleToolChoice/, 'Muse must preserve runtime-selected required or named tool choices')
