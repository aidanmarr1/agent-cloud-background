...
async function assertSourceContracts() {
  ...
  assert.match(agentLoop, /const FINAL_SAVED_DELIVERABLE_MAX_TOKENS = 1_200/, 'saved final deliverables must use bounded section chunks instead of one slow giant report/code call')
