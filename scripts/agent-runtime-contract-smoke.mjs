...
async function assertSourceContracts() {
  ...
  assert.match(panelHeader, /startup:\s*'Initializing computer'/, 'computer panel startup copy must describe actual initialization')
  assert.match(panelHeader, /planning:\s*'Planning'/, 'computer panel must show worker-emitted planning state')
  assert.match(typingIndicator, /Initializing computer/, 'startup indicator must describe actual initialization')
  assert.match(typingIndicator, /planning:\s*'Planning'/, 'typing indicator must show worker-emitted planning state')
