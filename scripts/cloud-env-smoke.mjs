...
requireExact('OPENROUTER_MODEL', 'google/gemini-3.5-flash', 'Gemini 3.5 Flash model route')
requireExact('OPENROUTER_REASONING_EFFORT', 'minimal', 'Gemini 3.5 Flash fast reasoning effort')
