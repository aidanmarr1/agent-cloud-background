...
requireExact('OPENROUTER_MODEL', 'google/gemini-3.1-flash-lite', 'Gemini 3.1 Flash Lite model route')
requireExact('OPENROUTER_REASONING_EFFORT', 'minimal', 'Gemini 3.1 Flash Lite fast reasoning effort')
