...
requireExact('OPENROUTER_MODEL', 'google/gemini-3.6-flash:exacto', 'Gemini 3.6 Flash Exacto route')
requireExact('OPENROUTER_REASONING_EFFORT', 'xhigh', 'configured reasoning effort')
