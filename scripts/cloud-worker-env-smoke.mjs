...
requireExact('OPENROUTER_MODEL', 'meta/muse-spark-1.2-contributor', 'pinned Muse Spark 1.2 Contributor model')
requireUnset('OPENROUTER_REASONING_EFFORT', 'Muse reasoning is pinned to minimal in code')
requireUnset('OPENROUTER_REASONING_EXCLUDE', 'Muse reasoning visibility is pinned per turn in code')
