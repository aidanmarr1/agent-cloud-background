...
requireExact('OPENROUTER_MODEL', 'meta/muse-spark-1.2', 'pinned Muse Spark 1.2 model')
requireUnset('OPENROUTER_REASONING_EFFORT', 'Muse uses per-turn native reasoning levels in code')
