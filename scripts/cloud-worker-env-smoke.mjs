...
requireExact('OPENROUTER_MODEL', 'google/gemini-3.5-flash-lite:nitro', 'Gemini 3.5 Flash Lite Nitro route')
requireExact('OPENROUTER_REASONING_EFFORT', 'medium', 'configured reasoning effort')
