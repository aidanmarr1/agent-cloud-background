...
requireUnset('OPENROUTER_REASONING_EFFORT', 'GLM reasoning is pinned to minimal in code')
requireUnset('OPENROUTER_REASONING_EXCLUDE', 'GLM reasoning visibility is pinned per turn in code')
