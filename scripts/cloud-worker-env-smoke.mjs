...
requireExact('OPENROUTER_MODEL', 'google/gemini-3.8-flash', 'pinned Gemini 3.8 Flash model')
requireExact('OPENROUTER_REASONING_EFFORT', 'low', 'lowest supported Gemini reasoning effort')
requireExact('OPENROUTER_PROVIDER_SORT', 'throughput', 'fastest available output token rate')
