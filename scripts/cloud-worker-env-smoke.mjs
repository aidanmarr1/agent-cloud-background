...
requireExact('OPENROUTER_MODEL', 'google/gemini-3.7-flash', 'pinned Gemini 3.7 Flash model')
requireUnset('OPENROUTER_REASONING_EFFORT', 'Gemini reasoning is pinned to minimal in code')
requireUnset('OPENROUTER_REASONING_EXCLUDE', 'Gemini reasoning visibility is pinned per turn in code')
