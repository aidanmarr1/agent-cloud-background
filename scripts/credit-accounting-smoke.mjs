...
async function assertSourceContracts() {
  ...
  assert.match(modelPricing, /DEFAULT_OPENROUTER_MODEL = 'google\/gemini-3\.5-flash-lite:exacto'/, 'default model must be Gemini 3.5 Flash Lite through OpenRouter Exacto')
