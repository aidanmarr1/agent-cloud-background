...
assert.match(taskRunner, /exact pre-terminal sandbox reconciliation barrier/, 'normal completion must rely on the retryable pre-terminal cleanup fence for exact E2B reconciliation')
