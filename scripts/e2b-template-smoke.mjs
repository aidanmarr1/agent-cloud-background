...
try {
  ...
  const command = [
    ...
    'yarn --version',
    'python3 --version',
    'python3 -c "import bs4, fastapi, matplotlib, numpy, openai, pandas, playwright, pydantic"',
    'java -version',
    'command -v bash',
    'command -v git',
    'command -v gh',
    ...
    'command -v pdfinfo',
    'command -v identify',
    'command -v agent-render-diagram',
    'command -v agent-md-to-pdf',
    'command -v agent-speech-to-text',
    'command -v agent-analyze-video',
    'command -v agent-upload-file',
    'command -v agent-sandbox-info',
    'command -v agent-scaffold-web',
    'test "$DISPLAY" = ":0"',
    'test "$HOME" = "/home/user"',
    'test "$USER" = "user"',
    'test "$SHELL" = "/bin/bash"',
    ...
    'test "$(id -u)" = "1000"',
    'sudo -n true',
    'test -d "$WEBDEV_TEMPLATES_PATH/web-static"',
    ...
    'agent-md-to-pdf e2b-smoke.md e2b-smoke.pdf',
    'test -s e2b-smoke.pdf',
    'agent-upload-file e2b-smoke.txt --json > e2b-upload.json',
    'grep -q "agent-artifact://" e2b-upload.json',
    'agent-sandbox-info > e2b-runtime.json',
    'grep -q "agent-parity-v1" e2b-runtime.json',
    'agent-scaffold-web e2b-web-smoke',
    'test -f e2b-web-smoke/package.json',
  ].join('\n')
