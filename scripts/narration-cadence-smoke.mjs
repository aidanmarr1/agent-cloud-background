...
export function runNarrationSmoke() {
  ...
  assert.deepEqual(Object.keys(cadenceSchemas[0].function.parameters.properties), ['query', 'progress_update'], 'ordinary action arguments must precede narration in the model-facing schema')
