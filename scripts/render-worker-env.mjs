...
const OBSOLETE_WORKER_ENV_KEYS = ['OPENROUTER_API_KEY', 'OPENROUTER_MODEL', 'OPENROUTER_REASONING_EFFORT', 'OPENROUTER_REASONING_EXCLUDE', 'DEEPSEEK_REASONING_EFFORT', 'DEEPSEEK_THINKING_ENABLED']
