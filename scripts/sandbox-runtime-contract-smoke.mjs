...
assert.match(dockerfile, /\bpkg-config\b/, 'Whisper BLAS build must include pkg-config')
assert.match(dockerfile, /\blibrsvg2-bin\b/, 'D2 PNG conversion must include rsvg-convert')
...
assert.match(diagramCommand, /command_path\("rsvg-convert"\)/)
