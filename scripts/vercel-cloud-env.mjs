...
const CLOUD_ENV = [
  ...
  { name: 'OPENROUTER_MODEL', value: 'google/gemini-3.5-flash-lite' },
  ...
  { name: 'AGENT_TASK_DISPATCH_MODE', value: 'render_job' },
  ...
  { name: 'AGENT_TASK_DISPATCH_MAX_ATTEMPTS', value: process.env.AGENT_TASK_DISPATCH_MAX_ATTEMPTS || '8' },
  ...
  { name: 'AGENT_REQUIRE_TASK_WORKER_HEARTBEAT', value: 'false' },
  { name: 'AGENT_REQUIRE_HOSTED_TASK_WORKER', value: 'false' },
  { name: 'RENDER_API_KEY', source: 'local', required: true },
  { name: 'RENDER_WORKER_SERVICE_ID', value: 'srv-d9hgelreo5us73e5gm80' },
  { name: 'RENDER_ON_DEMAND_JOB_PLAN_ID', value: 'plan-srv-006' },
  ...
  { name: 'AGENT_E2B_BROWSER_LAUNCH_TIMEOUT_MS', value: process.env.AGENT_E2B_BROWSER_LAUNCH_TIMEOUT_MS || '30000' },
