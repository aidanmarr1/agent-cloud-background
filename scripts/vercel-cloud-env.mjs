...
const OBSOLETE_CLOUD_ENV = ['DEEPSEEK_API_KEY', 'DEEPSEEK_MODEL', 'DEEPSEEK_REASONING_EFFORT', 'DEEPSEEK_THINKING_ENABLED', 'OPENROUTER_REASONING_EXCLUDE']
...
const CLOUD_ENV = [
  ...
  { name: 'OPENROUTER_MODEL', value: 'google/gemini-3.8-flash' },
  { name: 'OPENROUTER_REASONING_EFFORT', value: 'low' },
  { name: 'OPENROUTER_PROVIDER_SORT', value: 'throughput' },
