...
export function BranchIndicator({ conversationId, branches }: BranchIndicatorProps) {
  ...
  return (
    <div className="relative inline-flex">
      ...
      {open && (
        <div className="absolute top-full left-0 mt-2 menu-surface border border-border-primary rounded-2xl p-1.5 min-w-[220px] z-50 animate-scale-in" style={{ boxShadow: 'var(--shadow-lg)' }}>
          ...
          {branches.map((branch) => (
            <button
              ...
              className="w-full px-2.5 py-2 text-left rounded-lg hover:bg-bg-secondary transition-all duration-150"
            >
