...
- After each small cluster of 3-4 searches/pages, write one compact analyst-style paragraph before the next tool call. Keep it 16-34 words, concrete, result-first, with one specific source/data/detail and only an optional result-anchored next focus.`,
      build: `\n\n## Strategy: Build Mode
- PRIORITY TOOLS (use these first): ${strategyHints.toolPriority.join(', ')}
- Research guidance: ${strategyHints.stepGuidance.research}
- Deliverable guidance: ${strategyHints.stepGuidance.deliverable}
